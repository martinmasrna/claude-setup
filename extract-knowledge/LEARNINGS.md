...
Accumulated, user-ratified heuristics about this user's elicitation patterns and the
extraction workflow. Read this at the start of every run; apply what's here. Append new
