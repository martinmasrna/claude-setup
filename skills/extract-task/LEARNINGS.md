# Learnings — extract-task

Accumulated, user-ratified heuristics about this user's task-briefing patterns and the
context-extraction workflow. Read this at the start of every run; apply what's here. Append
